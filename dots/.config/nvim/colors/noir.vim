...
if has("gui_running") || &t_Co == 256
    ...
    hi CurSearch cterm=NONE ctermfg=15 ctermbg=236 gui=NONE guifg=#ffffff guibg=#303030
...
highlight! link DiagnosticWarn Error
highlight! link DiagnosticInfo Error
highlight! link DiagnosticHint Error
highlight! link DiagnosticOk Error
highlight! link DiagnosticVirtualTextError Error
highlight! link DiagnosticVirtualTextWarn Error
highlight! link DiagnosticVirtualTextInfo Error
highlight! link DiagnosticVirtualTextHint Error
highlight! link DiagnosticVirtualTextOk Error
highlight! link DiagnosticVirtualLinesError Error
highlight! link DiagnosticVirtualLinesWarn Error
highlight! link DiagnosticVirtualLinesInfo Error
highlight! link DiagnosticVirtualLinesHint Error
highlight! link DiagnosticVirtualLinesOk Error
highlight! link DiagnosticUnderlineError Error
highlight! link DiagnosticUnderlineWarn Error
highlight! link DiagnosticUnderlineInfo Error
highlight! link DiagnosticUnderlineHint Error
highlight! link DiagnosticUnderlineOk Error
highlight! link DiagnosticFloatingError Error
highlight! link DiagnosticFloatingWarn Error
highlight! link DiagnosticFloatingInfo Error
highlight! link DiagnosticFloatingHint Error
highlight! link DiagnosticFloatingOk Error
highlight! link DiagnosticSignError Error
highlight! link DiagnosticSignWarn Error
highlight! link DiagnosticSignInfo Error
highlight! link DiagnosticSignHint Error
highlight! link DiagnosticSignOk Error
highlight! link @comment.error Error
highlight! link @comment.warning Error
highlight! link @comment.todo Error
highlight! link @comment.note Error
